...
class PublicFormRead(BaseModel): form_id:UUID; business_id:UUID; business_name:str; business_slug:str; logo_url:str|None; brand_color:str; title:str; description:str|None; success_message:str
